    ...
    showModalBottomSheet(
      ...
      builder: (_) => const Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.workspace_premium, size: 50, color: Colors.blue),
            SizedBox(height: 10),
            Text("مدرسة التفوق",
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            SizedBox(height: 10),
            Text(
              "مدرسة رائدة تسعى لتقديم تعليم نوعي متميز باستخدام أحدث الوسائل التقنية",
              textAlign: TextAlign.center,
            ),
          ],
        ),
      ...
      builder: (_) => const Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.location_on, size: 50, color: Colors.red),
            SizedBox(height: 10),
            Text("اليمن - تعز - بجانب جامعة تعز"),
          ],
        ),
      ),
    );
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            const SizedBox(height: 80),
            const Icon(Icons.school, size: 120, color: Colors.amber),
            const SizedBox(height: 20),
            const Text("AL-Tafawuq Model School",
      ...
      bottomNavigationBar: BottomNavigationBar(
        onTap: (i) {
          if (i == 0) _showAboutSchool();
          if (i == 1) _showLocation();
          if (i == 2) _showSupport();
        },
        items: const [
          BottomNavigationBarItem(
              icon: Icon(Icons.workspace_premium), label: "عن المدرسة"),
          BottomNavigationBarItem(
              icon: Icon(Icons.location_on), label: "الموقع"),
          BottomNavigationBarItem(
              icon: Icon(Icons.support), label: "الدعم"),
        ],
      ),
    );
  }
...
class _MainHomePageState extends State<MainHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("AL-Tafawuq Model School"),
        backgroundColor: Colors.purple,
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const DataOnePage()));
              },
            ),
            ListTile(
              leading: const Icon(Icons.menu),
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const DatatwoPage()));
              },
            ),
          ],
        ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
              icon: Icon(Icons.grading), label: "النتائج"),
          BottomNavigationBarItem(
              icon: Icon(Icons.calendar_month), label: "الجدول"),
          BottomNavigationBarItem(
              icon: Icon(Icons.emoji_events), label: "الأوائل"),
          BottomNavigationBarItem(
              icon: Icon(Icons.payments), label: "الرسوم"),
          BottomNavigationBarItem(
              icon: Icon(Icons.how_to_reg), label: "الحضور"),
        ],
      ),
    );
  }
...
class ResultsPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text("صفحة نتائج الطلاب"));
  }
}
...
class TimetablePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text("صفحة الجدول الدراسي"));
  }
}
...
class TopStudentsPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text("صفحة أوائل الفصل"));
  }
}
...
class FeesPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text("صفحة الرسوم الدراسية"));
  }
}
...
class AttendancePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text("صفحة الغياب والحضور"));
  }
}
...
class DataOnePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      body: Center(child: Text("واجهة الإعدادات")),
    );
  }
}
...
class DatatwoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      body: Center(child: Text("واجهة العمليات")),
    );
  }
}
*/
